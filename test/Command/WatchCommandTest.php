...
class WatchCommandTest extends \Psy\Test\TestCase
{
    private $command;

    protected function setUp(): void
    {
        $this->command = new \Psy\Command\WatchCommand();
        $this->command->setApplication(new Shell());
    }

    public function testCommandExists()
    {
        $this->assertInstanceOf(\Psy\Command\WatchCommand::class, $this->command);
