...
class BreakCommandTest extends \Psy\Test\TestCase
{
    private $command;

    protected function setUp(): void
    {
        $this->command = new \Psy\Command\BreakCommand();
        $this->command->setApplication(new Shell());
    }

    public function testCommandExists()
    {
        $this->assertInstanceOf(\Psy\Command\BreakCommand::class, $this->command);
