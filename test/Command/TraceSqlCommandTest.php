...
class TraceSqlCommandTest extends \Psy\Test\TestCase
{
    private $command;

    protected function setUp(): void
    {
        $this->command = new \Psy\Command\TraceSqlCommand();
        $this->command->setApplication(new Shell());
    }

    public function testCommandExists()
    {
        $this->assertInstanceOf(\Psy\Command\TraceSqlCommand::class, $this->command);
