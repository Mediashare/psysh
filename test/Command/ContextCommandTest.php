...
class ContextCommandTest extends \Psy\Test\TestCase
{
    private $command;

    protected function setUp(): void
    {
        $this->command = new \Psy\Command\ContextCommand();
        $this->command->setApplication(new Shell());
    }

    public function testCommandExists()
    {
        $this->assertInstanceOf(\Psy\Command\ContextCommand::class, $this->command);
