...
HELP
     ...
     */
    protected function getBacktrace(\Throwable $e, ?int $count = null, bool $includePsy = true, bool $showParams = false): array
    {
        return TraceFormatter::formatTrace($e, $this->filter, $count, $includePsy, $showParams);
    }
}
